//
//  UFUIReplyQueryAddReplyToPostView.m
//  UnifiedForumUI
//
...
@interface UFUIReplyQueryAddReplyToPostView () <UITextViewDelegate>

@end

@implementation UFUIReplyQueryAddReplyToPostView
...
- (void)configWithAddReplyToPostVM:(UFUIReplyQueryAddReplyToPostViewModel *)addReplyToPostVM {
    self.addReplyToPostVM = addReplyToPostVM;
    
    self.toLabel.text = addReplyToPostVM.toLabelText;
    self.replyTextView.text = addReplyToPostVM.content;
}
...
- (void)textViewDidChange:(UITextView *)textView {
    ...
    self.addReplyToPostVM.content = text;
}

#pragma mark - Event Response

- (void)clickReplyButton:(id)sender {
    if ([self.delegate respondsToSelector:@selector(clickReplyButtonInAddReplyToPostView:)]) {
        [self.delegate clickReplyButtonInAddReplyToPostView:self];
    }
}
...
- (UIButton *)replyButton {
    if (!_replyButton) {
        ...
        [_replyButton setTitle:KUFUILocalization(@"UFUIReplyQueryViewController.replyQueryAddReplyToPostView.sendButton.title") forState:UIControlStateNormal];
