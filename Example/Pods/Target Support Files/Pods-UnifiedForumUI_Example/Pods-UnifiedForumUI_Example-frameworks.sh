...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UnifiedForumUI/UnifiedForumUI.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/YBImageBrowser/YBImageBrowser.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/YHPageViewControllerFramework/YHPageViewControllerFramework.framework"
